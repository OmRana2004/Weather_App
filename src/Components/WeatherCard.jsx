...
const WeatherCard = ({
  ...
  return (
    <div className="w-[22rem] min-w-[22rem] h-[30rem] glassCard p-4">
      <div className="flex-w-full just-center, iteams-center gap-4 mt-12 mb-4">
      ...
      <div className="w-full flex justify-between items-center mt-4 gap-4">
        <p className="flex-1 text-center p-2 font-bold bg-blue-600 shadow rounded-lg">
          Wind Speed <p className="font-normal">{windspeed} km/h</p> </p>
      ...
      <div className="w-full justify-center items-center text-3xl font-semibold">
        {conditions}
      </div>
    </div>
  );
